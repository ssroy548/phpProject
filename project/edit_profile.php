	...
	<div class="col-sm-8">
		<form action="" method="post" enctype="multipart/form-data">
			<table class="table table-bordered table-hover">
				...
				<tr>
					<td style="font-weight: bold;">Chanege Your Password</td>
					<td>
				...
				<tr>
					<td style="font-weight: bold;">Chanege Your Email</td>
					<td>
				...
				<tr>
					<td style="font-weight: bold;">Chanege Your Birthday</td>
					<td>
				...
				<tr>
					...
					<td>
						...
						<dir id="myModal" class="modal fade" role="dialog">
								...
								<div class="modal-content">
									...
									<div class="modal-body">
										...
										<?php
											...
											if($bfn == ''){
											echo"<script>alert('Please give input')</script>";
										...
										echo"<script>alert('Error while Updateing information')</script>";
										echo"<script>window.open('edit_profile.php?u_id$user_id','_self')</script>";
								}
									}
										}
