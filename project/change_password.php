...
<body>
	<div class="row">
		<div class="col-sm-12">
			<div class="well">
				<center><h1 style="color: white;"><strong>Corporate World</strong></h1></center>
			</div>
		</div>
	</div>
	<div class="row">
...
<?php
	if(isset($_POST['change'])){
		...
		$pass1 = $email = htmlentities(mysqli_real_escape_string($con,$_POST['pass1']));
		...
		echo"<script>window.open('home.php','_self')</script>";
			...
			echo"<script>alert('Your Password should be greater than 5 character')</script>";
		}
	}
		else{
