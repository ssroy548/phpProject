		...
		<div class="col-sm-6">
			<div class="load_msg" id="scroll_messages">
				<?php
					...
					<div id="loaded_msg">
						<p><?php if($user_to == $user_to_msg AND $user_from == $user_from_msg){echo "<div class='message' id='blue' date-toggle='tooltip' title='$msg_date'>$msg_body</div><br><br><br>";}else if($user_from == $user_to_msg AND $user_to == $user_from_msg){echo " <div class='message' id='green' 
							date-toggle='tooltip' title='$msg_date'>$msg_body</div><br><br><br>";}?></p>
					</div>
